...
public class ZpoControlConsentimientosRecepcionHelper {
	
	public static ContentValues crearZpoControlConsentimientosRecepcion(ZpoControlConsentimientosRecepcion datos){
	...
	public static ZpoControlConsentimientosRecepcion crearZpoControlConsentimientosRecepcion(Cursor cursorDatos){
		ZpoControlConsentimientosRecepcion mDatos = new ZpoControlConsentimientosRecepcion();
