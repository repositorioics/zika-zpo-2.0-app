...
public class ZpoV2MullenHelper {
    ...
    public static ZpoV2Mullen crearZpoV2Mullen(Cursor cursor){
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.adjAgeMsel))>0) zpMullen.setAdjAgeMsel(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.adjAgeMsel)));
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.gmTScore))>0) zpMullen.setGmTScore(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.gmTScore)));
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.vrTScore))>0) zpMullen.setVrTScore(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.vrTScore)));
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.fmTScore))>0) zpMullen.setFmTScore(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.fmTScore)));
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.elTScore))>0) zpMullen.setElTScore(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.elTScore)));
        ...
        if (cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.cognTScoreSum))>0) zpMullen.setCognTScoreSum(cursor.getInt(cursor.getColumnIndex(ZpoV2MullenConstants.cognTScoreSum)));
