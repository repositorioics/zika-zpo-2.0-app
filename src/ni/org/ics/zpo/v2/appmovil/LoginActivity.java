...
public class LoginActivity extends Activity {
	...
	public void attemptLogin() {
		...
		((MyZpoApplication) this.getApplication()).setPassApp(mPassword);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				successLogin=true;	
				ZpoAdapter ca = new ZpoAdapter(getApplicationContext(),mPassword,true, chkWipe.isChecked());
				ca.open();
				ca.borrarUsuarios();
				ca.borrarRoles();
	...
	private void ingresarLocal() {
		...
		ZpoAdapter ca = new ZpoAdapter(getApplicationContext(),mPassword,false,chkWipe.isChecked());
		try{
			ca.open();
