 ...
 * @author ics
 */
public class NewZpoV2ActCuestSaludMaternaActivity extends AbstractAsyncActivity {

    protected static final String TAG = NewZpoV2ActCuestSaludMaternaActivity.class.getSimpleName();
        ...
        try {
            ...
            if (mZpoV2CuestSaludMat == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'ZpoV2_Act_Cuestionario_Salud_Materna' and displayName = 'Continuacion Estudio ZPO Actualizacion Cuestionario Salud Materna'", null, null);
                c.moveToFirst();
    ...
    private void parseZpoCuestDemografico(Integer idInstancia, String instanceFilePath, Integer accion) {
        ...
        try {
            ...
            mZpoV2CuestSaludMat.setEmbarazadaVisitaMaternalUpd(zpoV2CSMXml.getEmbarazadaVisitaMaternalUpd());
            mZpoV2CuestSaludMat.setDadoLuzMaternalUpd(zpoV2CSMXml.getDadoLuzMaternalUpd());
