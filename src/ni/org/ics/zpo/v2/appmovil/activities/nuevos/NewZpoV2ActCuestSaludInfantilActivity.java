 ...
 * @author ics
 */
public class NewZpoV2ActCuestSaludInfantilActivity extends AbstractAsyncActivity {

    protected static final String TAG = NewZpoV2ActCuestSaludInfantilActivity.class.getSimpleName();
    ...
    private void createInitDialog() {
        ...
        if (mZpoV2CuestSaludInf != null) {
            message.setText(getString(R.string.edit) + " " + getString(R.string.infant_b_18) + "?");
        } else {
            message.setText(getString(R.string.add) + " " + getString(R.string.infant_b_18) + "?");
        }
        ...
        try {
            ...
            if (mZpoV2CuestSaludInf == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'ZpoV2_Act_Cuestionario_Salud_Infantil' and displayName = 'Continuacion Estudio ZPO Cuestionario Salud Infantil'", null, null);
                c.moveToFirst();
    ...
    private void parseZpoCuestDemografico(Integer idInstancia, String instanceFilePath, Integer accion) {
        ...
        try {
            ...
            mZpoV2CuestSaludInf.setProblemaComerNinoUpd(zpoV2CSIXml.getProblemaComerNinoUpd());
            mZpoV2CuestSaludInf.setDescripcionProbNeuroNinoUpd(zpoV2CSIXml.getDescripcionProbNeuroNinoUpd());
