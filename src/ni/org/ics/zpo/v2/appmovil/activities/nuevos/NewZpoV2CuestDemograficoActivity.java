 ...
 * @author ics
 */
public class NewZpoV2CuestDemograficoActivity extends AbstractAsyncActivity {

    protected static final String TAG = NewZpoV2CuestDemograficoActivity.class.getSimpleName();
    ...
    private void createInitDialog() {
        ...
        if (mZpoV2CuestDemog != null) {
            message.setText(getString(R.string.edit) + " " + getString(R.string.infant_b_15) + "?");
        } else {
            message.setText(getString(R.string.add) + " " + getString(R.string.infant_b_15) + "?");
        }
        ...
        try {
            ...
            if (mZpoV2CuestDemog == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'ZpoV2_Cuestionario Demografico' and displayName = 'Continuacion Estudio ZPO Cuestionario Demografico'", null, null);
                c.moveToFirst();
    ...
    private void parseZpoCuestDemografico(Integer idInstancia, String instanceFilePath, Integer accion) {
        ...
        try {
            ...
            mZpoV2CuestDemog.setNombreMadreDemogr(zpoV2CDEMXml.getNombreMadreDemogr());
            if (infantData != null) mZpoV2CuestDemog.setCodigoMadreDemogr(infantData.getPregnantId());
            mZpoV2CuestDemog.setNombreNinoDemogr(zpoV2CDEMXml.getNombreNinoDemogr());
            mZpoV2CuestDemog.setNombrePadreDemogr(zpoV2CDEMXml.getNombrePadreDemogr());
            mZpoV2CuestDemog.setFechaNacMadreDemogr(zpoV2CDEMXml.getFechaNacMadreDemogr());
            mZpoV2CuestDemog.setFechaNacNinoDemogr(zpoV2CDEMXml.getFechaNacNinoDemogr());
            mZpoV2CuestDemog.setFechaNacPadreDemogr(zpoV2CDEMXml.getFechaNacPadreDemogr());
            mZpoV2CuestDemog.setSexoDemogr(zpoV2CDEMXml.getSexoDemogr());
            ...
            mZpoV2CuestDemog.setUbicCasaDemogr(zpoV2CDEMXml.getUbicCasaDemogr());
            ...
            mZpoV2CuestDemog.setEtnicidadDemogr(zpoV2CDEMXml.getEtnicidadDemogr());
            mZpoV2CuestDemog.setRazaDemogr(zpoV2CDEMXml.getRazaDemogr());
            mZpoV2CuestDemog.setEstadoCivilDemogr(zpoV2CDEMXml.getEstadoCivilDemogr());
            mZpoV2CuestDemog.setEscolaridadMadreDemogr(zpoV2CDEMXml.getEscolaridadMadreDemogr());
            mZpoV2CuestDemog.setEscolaridadPadreDemogr(zpoV2CDEMXml.getEscolaridadPadreDemogr());
